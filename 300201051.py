def prepareInfo (data, stage):
    if stage == "categories.txt":
        ...
        for i in new_file:
            ...
            if name1[0] == data:
                list1.append(name1[1])  #Hold the datas separatly in different lists list1 and list2.
...
def printMenu(list):    
    nth = 1     # Assign for number of datas.
    for i in list:      # In this for loop, it print number of datas. Ex: 1. ..., 2. ... etc.
        print(str(nth) + ".", i)
        nth += 1
    
def getUserInput(file):     #Get a input from user and check the input.
    try:
...
while answer == "y":                                                                                        #If the user want to add product, then this while loop will print the funtions again.  
        category_ids, category_names = prepareInfo(0, "categories.txt")                                     #Call the function for satge of category.
        ...
        print(f"Selected category: {category_names[selected_category_index - 1]}")                          #Result of order.
...
print("Order Recipe")                                                                                       #Print the order table by using list that was defined empty out of while loop.
print("==============================================================")
for i in range(order):
    #print(i)                                                                                               #For testing. No matter.
